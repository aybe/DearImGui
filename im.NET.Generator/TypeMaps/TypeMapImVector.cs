...
internal sealed class TypeMapImVector : TypeMapBase
{
    public override Type CSharpSignatureType(TypePrinterContext ctx)
    {
        if ((ctx.Kind, ctx.MarshalKind) is (TypePrinterContextKind.Native, MarshalKind.NativeField))
            return new CustomType("ImVector.__Internal"); // the stuff is auto-generated by CppSharp
    ...
    public override void CSharpMarshalToNative(CSharpMarshalContext ctx)
    {
        if (ctx.Function == null)
        {
            ...
            {
                ctx.Return.Write(ctx.ReturnVarName); // not valid but pruned by SetPropertyAsReadOnly
            }
        }
        else
        {
